...
doc_export:
	$(xcrun --find docc) process-archive transform-for-static-hosting DerivedData/Demo.doccarchive --output-path docs --hosting-base-path surfstudio.github.io/vsurf-demo/
	$(xcrun --find docc) process-archive transform-for-static-hosting DerivedData/DemoTutorials.doccarchive --output-path docs --hosting-base-path surfstudio.github.io/vsurf-demo/
